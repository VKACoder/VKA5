...
(
    ...
    branch_taken_o,
    target_addr_o,
    is_load_type_o, is_store_type_o    
);
    ...
    output [6:0] is_load_type_o;
    output [3:0] is_store_type_o;
    ...
    wire [31:0] sraw_result  = $signed(rdata1_i[31:0]) >>> rdata2_i[4:0];
    
    wire [31:0] slliw_result  = rdata1_i[31:0] << imm_value_i[4:0];
    wire [31:0] srliw_result  = rdata1_i[31:0] >> imm_value_i[4:0];
    wire [31:0] sraiw_result  = $signed(rdata1_i[31:0]) >>> imm_value_i[4:0];
    ...
    wire bltu_true = op_i.is_bltu ? rdata1_i < rdata2_i                    : 1'b 0;
    
    wire branch_taken = beq_true || bne_true || bge_true || blt_true || bgeu_true || bltu_true;
    ...
    assign branch_taken_o = branch_taken || op_i.is_jal || op_i.is_jalr;
    assign target_addr_o  = branch_taken_o ? alu_result_o : 64'd 0;
    
    assign is_load_type_o  = {op_i.is_ld, op_i.is_lw, op_i.is_lwu, op_i.is_lh, op_i.is_lhu, op_i.is_lb, op_i.is_lbu}; 
    assign is_store_type_o = {op_i.is_sd, op_i.is_sw, op_i.is_sh, op_i.is_sb};
    
    assign alu_result_o = op_i.is_add     ? rdata1_i + rdata2_i                    :
                          op_i.is_sub     ? rdata1_i - rdata2_i                    :
                          op_i.is_sll     ? rdata1_i << rdata2_i[5:0]              :
                          op_i.is_srl     ? rdata1_i >> rdata2_i[5:0]              :
                          op_i.is_sra     ? $signed(rdata1_i) >>> rdata2_i[5:0]    : 
                          ...
                          is_load_type_o  ? rdata1_i + imm_value_i                 :
                          is_store_type_o ? rdata1_i + imm_value_i                 :
                          branch_taken  ? current_pc_i + imm_value_i             : //Single alu result as the expected branch address 
